...
public class BoardUserLinkedRepository<T extends BaseEntity & BoardLinked & UserLinked & Identifiable> implements CRUDRepository<T>, BoardAggregateRepository<T> {
