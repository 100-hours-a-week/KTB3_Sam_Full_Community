...
public class InMemoryBoardUserLinkedRepository<T extends BaseEntity & BoardLinked & UserLinked & Identifiable> implements CRUDRepository<T>, BoardAggregateRepository<T> {
